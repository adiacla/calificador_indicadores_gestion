...
def generar_estadisticas():
    ...
    # Markdown reutiliza la lógica existente
...
"""
    ...
    if not df_calificacion.empty:
        ...
        fig_calificacion.update_layout(
            showlegend=True, height=400, margin=dict(t=50, b=50, l=50, r=50)
        )
    else:
        fig_calificacion = go.Figure().add_annotation(
            text="No hay datos de calificación", showarrow=False
        )
    ...
    if not df_tipo.empty:
        fig_tipo = px.bar(
            ...
            x="Tipo",
            y="Cantidad",
            title="Distribución por Tipo de Indicador",
            text="Cantidad",
        ...
        fig_tipo = go.Figure().add_annotation(
            text="No hay datos de tipo de indicador", showarrow=False
        )
